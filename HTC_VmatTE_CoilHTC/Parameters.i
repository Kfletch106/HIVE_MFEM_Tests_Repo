...
Coil_Vol_Flow = 0.0008333
Coil_Width = 0.036
Hydrualic_Diameter = (4*Coil_Width*Coil_Width)/(2 *(Coil_Width + Coil_Width))
Re_Coil = ${fparse 919.131*Coil_Vol_Flow*Hydrualic_Diameter/0.00018551566535600087}
Pr_Coil = 1.170613923301386
Nu_Coil = ${fparse 0.023*pow(Re_Coil,0.8)*pow(Pr_Coil,0.4)}
HTC_Coil = ${fparse Nu_Coil*0.6062696884457435/Hydrualic_Diameter}
