...
[Functions]
  ...
  [loss_coef_coil]
    ...
    symbol_names = 'sigma_coil'
    symbol_values = sigma_coil
  []
  [loss_coef_target]
    type = ParsedFunction
  ...
  [sigma_target]
    type = ParsedFunction
    expression = 'c0 / (1 + b*(T_avg - ${room_temperature}))'
    symbol_names = 'c0 b T_avg'
    symbol_values = '${steel_econductivity_0} 0.0045 T_avg'
  []
  [sigma_coil]
    type = ParsedFunction
    expression = 'c0 / (1 + b*(T_avg - ${room_temperature}))'
    symbol_names = 'c0 b T_avg'
    symbol_values = '${copper_econductivity_0} 0.0039 T_avg'
  []
[]
